		...
		Ai1wm_Status::done(
			...
			sprintf(
				__(
					...
					'<strong>1. You must save your permalinks structure twice, and if you feel like it 3 times. <a class="ai1wm-no-underline" href="%s" target="_blank">Permalinks Settings</a></strong> <small>(opens a new window)</small><br />' .
					'<strong>2. <a class="ai1wm-no-underline" href="https://www.youtube.com/c/WPressDoctor/?sub_confirmation=1" target="_blank">Subscribe to the WPress Doctor Channel</a>.</strong> <small>(opens a new window)</small>',
					AI1WM_PLUGIN_NAME
				),
